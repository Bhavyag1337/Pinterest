  ...
  ({ className, ...props }, ref) => {
    return (
      <input
        type="search"
        className={cn(
          "flex h-12 w-full rounded-full bg-search border-0 px-5 py-2 text-base placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 transition-all",
          className
        )}
        ref={ref}
        {...props}
